// task kyu 8 "101 Dalmatians - squash the bugs, not the dogs!"
...
/*Ваш друг пошел покупать щенков (какое время, чтобы быть живым!)... Он возвращается с несколькими собаками, и вы просто не знаете, что ответить!
